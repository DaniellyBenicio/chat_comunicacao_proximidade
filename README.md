# GeoTalk — Chat por Proximidade (Sem Internet)
...
O **GeoTalk** é um aplicativo de bate-papo por proximidade que permite trocar mensagens em tempo real com pessoas que estão fisicamente perto de você (até ~100 metros), mesmo sem internet, sem Wi-Fi público e sem usar seus dados móveis.
...
### Funcionalidades Atuais (2025)

- Conexão automática por proximidade
- Mensagens de texto em tempo real
- Nome personalizado (você escolhe como quer aparecer)
...
- Excluir conversa com toque longo
...
# 4. Conecte dois celulares Android via USB (ou use emuladores)

# 5. Execute nos dois dispositivos:
flutter run